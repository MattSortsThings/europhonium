...
|:------------------------------------------------------------------------------------------------:|
|                  The logo for the 2025 Eurovision Song Contest in Basel, 2025.                   |
...
A given **broadcast** has a number of **competing countries**: between 15 and 20 for a semi-final and 25-26 for a grand final. The competing countries perform their songs on stage in a pre-determined order.
...
1. The competing countries are ordered by descending total points.
...
At the time of development, no rule or format changes have been announced for the forthcoming 2025 edition of the Eurovision Song Contest. The system will be developed for the "Stockholm" and "Liverpool" rules only.
