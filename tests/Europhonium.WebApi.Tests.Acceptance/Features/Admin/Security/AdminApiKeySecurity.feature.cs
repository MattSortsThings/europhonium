...
namespace Europhonium.WebApi.Tests.Acceptance.Features.Admin.Security
{
    using Reqnroll;
    using System;
    using System.Linq;
...
#line hidden
#line 10
        await testRunner.WhenAsync("I request 5 greetings in Dutch", ((string)(null)), ((global::Reqnroll.Table)(null)), "When ");
#line hidden
#line 11
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="Public API key authenticated but not authorized")]
        [Xunit.TraitAttribute("FeatureTitle", "Admin Api Key Security")]
        [Xunit.TraitAttribute("Description", "Public API key authenticated but not authorized")]
        [Xunit.TraitAttribute("Category", "SadPath")]
        public async System.Threading.Tasks.Task PublicAPIKeyAuthenticatedButNotAuthorized()
        {
            string[] tagsOfScenario = new string[] {
                    "SadPath"};
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
